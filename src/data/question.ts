        ...
        question: [
            {
                ...
                answer: `Мы принимаем безопасность ваших **персональных данных** очень серьезно. Все данные шифруются с использованием современных алгоритмов шифрования, таких как **AES-256**. Это обеспечивает защиту от несанкционированного доступа при передаче и хранении данных. Убедитесь, что вы используете надежный пароль и регулярно обновляете его!`
            },
            {
                question: 'Как применяются **права доступа** в приложении?',
                answer: `Приложение **Берсерк Ассистент** требует **права доступа** только к тем функциям, которые необходимы для его нормальной работы. Например, доступ к интернету нужен для загрузки обновлений и карт, а доступ к уведомлениям — для получения важных оповещений о событиях в игре. Вы можете управлять правами доступа в настройках вашего устройства.`
            },
            {
...
- Не делитесь своими учетными данными с другими пользователями.`
            ...
            {
                question: 'Какое необходимо **действие** в случае подозрительной активности в моем аккаунте?',
...
- Проверьте, есть ли несанкционированные транзакции или изменения в вашем профиле.`
            ...
            {
                question: 'Как приложение защищает **платежные данные**?',
                answer: `Все **платежные данные** обрабатываются с использованием защищенных протоколов шифрования, таких как **SSL/TLS**, чтобы обеспечить защиту вашей финансовой информации. Мы не храним данные ваших платежных карт на наших серверах, а используем безопасные платежные шлюзы для обработки транзакций.`
            },
        ],
    },
    ...
    'support': {
        ...
        question: [
            ...
            {
                question: 'Большие баги. Как их сообщить?',
                answer: `Если обнаружили баг, сообщите о нём через раздел «Связаться с нами» или оставьте отзыв в магазине приложений.`
            },
            {

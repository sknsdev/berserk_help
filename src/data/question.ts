...
[![image.png](https://i.postimg.cc/PfSqcw73/image.png)](https://postimg.cc/4nhZHmsV)`
    ...
    'support': {
        ...
        question: [
            {
                question: 'Кто является разработчиком приложения Берсерк Ассистент', answer: `
                
## Контактная информация

### Имя разработчика:

[Власов Алексей Сергеевич](mailto:alexey.vlasov97@mail.ru)
...
[alexey.vlasov97@mail.ru](mailto:alexey.vlasov97@mail.ru)

### Номер телефона:

[+7 988 556-25-20](tel:+7 988 556-25-20)
